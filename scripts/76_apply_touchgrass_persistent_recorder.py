...
#define TGREC_BUILD_ID          "TG77F1"
#define TGREC_BUILD_DESC        "phase77 llvm17 fixed-eevdf bpf-jit-api interpreter-backend"
...
def main() -> int:
    ...
    checks = {
        "build_identity": 'TGREC_BUILD_ID          "TG77F1"' in SOURCE,
        "phase72_identity": "phase77 llvm17 fixed-eevdf bpf-jit-api interpreter-backend" in SOURCE,
