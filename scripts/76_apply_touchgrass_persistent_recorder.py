...
#define TGREC_BUILD_ID          "TG79C1"
#define TGREC_BUILD_DESC        "phase79 llvm17 fixed-eevdf real-jit unguarded"
...
def main() -> int:
    ...
    checks = {
        "build_identity": 'TGREC_BUILD_ID          "TG79C1"' in SOURCE,
        "phase79_identity": "phase79 llvm17 fixed-eevdf real-jit unguarded" in SOURCE,
