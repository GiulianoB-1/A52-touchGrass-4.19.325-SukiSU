...
#define TGREC_BUILD_ID          "TG80F1"
#define TGREC_BUILD_DESC        "phase80 llvm17 fixed-eevdf real-jit fp-x24"
...
def main() -> int:
    ...
    checks = {
        "build_identity": 'TGREC_BUILD_ID          "TG80F1"' in SOURCE,
        "phase80_identity": "phase80 llvm17 fixed-eevdf real-jit fp-x24" in SOURCE,
