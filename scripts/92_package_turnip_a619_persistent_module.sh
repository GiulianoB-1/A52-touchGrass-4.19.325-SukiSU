...
description=Stable arm64 Mesa 26.2.2 Turnip Vulkan 1.4 for A52 5G / Adreno 619 KGSL. Includes validated Android AHB/YV12/QTI UBWC paths and the legacy-KGSL nonblocking timeout-zero fence poll fix that removes RenderThread stalls.
EOF
