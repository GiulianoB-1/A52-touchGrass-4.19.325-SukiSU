...
GENERATED="$SCRIPT_DIR/.phase95-generated-resukisu-susfs.sh"
...
: "${LABEL:?Phase95 LABEL environment variable is required}"
...
echo "phase95_kernelversion=$TARGET_VERSION"
echo "phase95_image=$CANON_IMAGE"
echo "phase95_config=$CANON_CONFIG"
