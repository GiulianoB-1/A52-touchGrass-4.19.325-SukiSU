...
#define TGREC_BUILD_ID          "TG81C1"
#define TGREC_BUILD_DESC        "phase81 llvm17 fixed-eevdf real-jit callframe-no-x25"
...
def main() -> int:
    ...
    checks = {
        "build_identity": 'TGREC_BUILD_ID          "TG81C1"' in SOURCE,
        "phase81_identity": "phase81 llvm17 fixed-eevdf real-jit callframe-no-x25" in SOURCE,
