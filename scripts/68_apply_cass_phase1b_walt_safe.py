...
if len(sys.argv) != 2:
    raise SystemExit("usage: 68_apply_cass_phase1b_walt_safe.py <kernel-tree>")
...
# This is intentionally a clean CASS-only experiment.
eevdf_markers = (
    "sched_eevdf_enabled",
 ...
 *
 * A52 Phase 1b, conservative Samsung 4.19/WALT adaptation.
 *
 ...
 *
 * EEVDF is intentionally absent and RT placement remains legacy.
 */
...
checks = {
    cass_c: [
        ...
        '__setup("sched_cass="',
        "CASS phase 1b fair CPU placement path is active",
    ],
    fair_c: [
        '#include "cass.c"',
        ".select_task_rq\t\t= cass_select_task_rq_fair,",
...
print("CASS phase 1b A52/WALT-safe port applied")
print("kernel=4.19.x")
