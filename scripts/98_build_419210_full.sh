...
GENERATED="$SCRIPT_DIR/.phase98-generated-resukisu-susfs.sh"
...
: "${LABEL:?Phase98 LABEL environment variable is required}"
...
echo "phase98_kernelversion=$TARGET_VERSION"
echo "phase98_image=$CANON_IMAGE"
echo "phase98_config=$CANON_CONFIG"
