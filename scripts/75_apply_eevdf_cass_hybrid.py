...
if len(sys.argv) != 2:
    raise SystemExit("usage: 75_apply_eevdf_cass_hybrid.py <kernel-tree>")
...
checks = {
    cass_c: [
        ...
        '__setup("sched_cass="',
        "CASS+EEVDF hybrid fair CPU placement path is active",
    ],
    fair_c: [
        '#include "cass.c"',
        ".select_task_rq\t\t= cass_select_task_rq_fair,",
...
print("CASS+EEVDF hybrid A52/WALT-safe placement port applied")
print("kernel=4.19.x")
...
print("eevdf=fixed_multitask_runtime_gate_retained")
