...
GENERATED="$SCRIPT_DIR/.phase97-generated-resukisu-susfs.sh"
...
: "${LABEL:?Phase97 LABEL environment variable is required}"
...
echo "phase97_kernelversion=$TARGET_VERSION"
echo "phase97_image=$CANON_IMAGE"
echo "phase97_config=$CANON_CONFIG"
