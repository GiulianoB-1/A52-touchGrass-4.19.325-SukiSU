...
'''
    text = replace_once(text, old_audit, new_audit, "object audit fallback")
    return text
...
"""
    patcher = replace_once(patcher, old_status, new_status, "checkpoint status map")
...
'''
    patcher = replace_once(
        ...
        "recorder instrumentation insertion",
    )
...
def main() -> int:
    ...
    print("checkpoint instrumentation applied")
    return 0
