...
GENERATED="$SCRIPT_DIR/.phase96-generated-resukisu-susfs.sh"
...
: "${LABEL:?Phase96 LABEL environment variable is required}"
...
echo "phase96_kernelversion=$TARGET_VERSION"
echo "phase96_image=$CANON_IMAGE"
echo "phase96_config=$CANON_CONFIG"
