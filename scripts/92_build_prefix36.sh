...
GENERATED="$SCRIPT_DIR/.phase92-generated-resukisu-susfs.sh"
...
: "${LABEL:?Phase92 LABEL environment variable is required}"
...
echo "phase92_kernelversion=$TARGET_VERSION"
echo "phase92_image=$CANON_IMAGE"
echo "phase92_config=$CANON_CONFIG"
