...
GENERATED="$SCRIPT_DIR/.phase94b-generated-resukisu-susfs.sh"
...
: "${LABEL:?Phase94B LABEL environment variable is required}"
...
echo "phase94b_kernelversion=$TARGET_VERSION"
echo "phase94b_image=$CANON_IMAGE"
echo "phase94b_config=$CANON_CONFIG"
