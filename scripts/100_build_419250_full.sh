...
GENERATED="$SCRIPT_DIR/.phase100-generated-resukisu-susfs.sh"
...
: "${LABEL:?Phase100 LABEL environment variable is required}"
...
echo "phase100_kernelversion=$TARGET_VERSION"
echo "phase100_image=$CANON_IMAGE"
echo "phase100_config=$CANON_CONFIG"
