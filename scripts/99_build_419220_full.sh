...
GENERATED="$SCRIPT_DIR/.phase99-generated-resukisu-susfs.sh"
...
: "${LABEL:?Phase99 LABEL environment variable is required}"
...
echo "phase99_kernelversion=$TARGET_VERSION"
echo "phase99_image=$CANON_IMAGE"
echo "phase99_config=$CANON_CONFIG"
