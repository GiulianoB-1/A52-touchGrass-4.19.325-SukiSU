...
#define TGREC_BUILD_ID          "TG84P1"
#define TGREC_BUILD_DESC        "phase84 llvm17 fixed-eevdf real-jit x25-outofframe-probe"
...
def main() -> int:
    ...
    checks = {
        "build_identity": 'TGREC_BUILD_ID          "TG84P1"' in SOURCE,
        "phase84_identity": "phase84 llvm17 fixed-eevdf real-jit x25-outofframe-probe" in SOURCE,
